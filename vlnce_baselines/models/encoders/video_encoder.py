...
class VideoRGBEcnoder(nn.Module):
    ...
    def __init__(
        ...
        if "Large" in model_name:
            ...
            args.finetune = '/root/mount/dcvln-joslin/data/pretrained/VideoMAE/vit_l_hybrid_pt_800e.pth'
        elif "Base" in model_name:
            args.model = 'vit_base_patch16_224'
            args.finetune = '/root/mount/dcvln-joslin/data/pretrained/VideoMAE/vit_b_hybrid_pt_800e.pth'
